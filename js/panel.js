...
function _pnGetRenderer(tabId) {
    ...
    if (tabId === 'pn-projects') return pnRenderProjects;
...
// ══════════════════════════════════════════════════════════════════════
// PROYECTOS — seguimiento general (v16.6)
// No es solo mantenimiento: reparaciones, proyectos de inversión, cualquier
// iniciativa con pasos, responsables y fechas. steps[] son las filas capturadas
// (tabla tipo Loop); log[] son notas libres. La línea de tiempo NUNCA se
// guarda — se deriva mezclando log[] con los cambios de estado de los pasos
// (pnProjectTimeline), igual que v.timeline/g.timeline en otros módulos.
// ══════════════════════════════════════════════════════════════════════
