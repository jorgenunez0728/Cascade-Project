...
function tpAutoGenerateIfNeeded() {
    ...
    try {
        ...
        if (lastIdx >= 0 && tpState.weeklyPlans[lastIdx].smartGenerated) {
            ...
            if (typeof paSendWeeklyPlan === 'function') {
                paSendWeeklyPlan(tpState.weeklyPlans[lastIdx]);
            }

            if (typeof showToast === 'function') showToast('Plan semana ' + check.nextMonday + ' generado y enviado a Power Automate', 'success');
