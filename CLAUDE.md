...
Single-page web application for KIA Mexico's Emissions Laboratory. 4 modules, 180 functions, 100% offline using localStorage. Used daily on smartphones/tablets by lab technicians.
...
- **CDN dependencies**: signature_pad (for digital signatures) and jsPDF (for PDF generation) are loaded from CDN in the head
