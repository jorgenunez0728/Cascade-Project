...
for jsfile in app.js cop15.js inventory.js testplan.js panel.js projects.js auth.js signatures.js firebase-sync.js cop_validator.js homolog.js bugreport.js; do
    echo "" >> "$DIR/$OUTPUT"
